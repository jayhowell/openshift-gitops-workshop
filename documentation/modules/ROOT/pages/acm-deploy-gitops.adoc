...
Let’s just do *one more step*: This step insures that the lab user has the right permissions to create policies with policy generator. Login to your Cluster and click the + sign at the top.  Past the following yaml and click apply. 
